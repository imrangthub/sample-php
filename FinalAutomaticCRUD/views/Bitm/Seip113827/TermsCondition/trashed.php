...
$AllTmCondition=$termsConditionObj->trashed();
        ...
        foreach($AllTmCondition as $singleTmCondition){
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="recover.php? id=<?php echo $singleTmCondition['id'] ?>">Recovery</a>|
                    <a href="delete.php? id=<?php echo $singleTmCondition['id'] ?>">P_Deleted</a>|
                </td>
            </tr>
        <?php } ?>
    <?php }else{
