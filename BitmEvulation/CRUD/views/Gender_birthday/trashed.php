...
$allPerson=$genderBirthdayObj->trashed();
            ...
            foreach ($allPerson as $singlePerson) {
                ...
                <tr>
                    ...
                    <td><a href="show.php? id=<?php echo $singlePerson['id'] ?>">show |</a>
                        <a href="recover.php? id=<?php echo $singlePerson['id'] ?>">recover |</a>
                        <a href="delete.php? id=<?php echo $singlePerson['id'] ?>">p_delete</a></td>
                </tr>
                <?php
            }
        }
...
<div id="sub">
    <table align="center">
        <tr><td><a href="index.php">Back</a> to home.</td></tr>
    </table>
</div>
</body>
</html>
