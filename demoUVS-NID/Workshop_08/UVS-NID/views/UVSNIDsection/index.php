                    ...
                    <div class="bodyContent">
                        <div class="pageContent">
                            <div class="uvsnidHeading">
                                ...
                                <h5>About all Section.</h5>
                            </div>
                            <div class="dataSection">
                                <ul>
                                    <li><a href="PrimarySection/index.php">Primary Section.</a> </li>
                                    <li><a href="SecondarySection/index.php">Secondary Section.</a> </li>
                                    <li><a href="CrimeSection/index.php">Crime Section.</a> </li>
                                </ul>
                            </div>
