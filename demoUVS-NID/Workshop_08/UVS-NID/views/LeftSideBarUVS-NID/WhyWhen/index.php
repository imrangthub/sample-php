...
<head>
    ...
    <title>why and Where</title>
    <link rel="stylesheet" href="../../../css/bootstrapCSS/bootstrap.min.css" />
    <link rel="stylesheet" href="../../../css/myCSS/styleBasicHome.css"/>
    <link rel="stylesheet" href="../../../css/myCSS/styleNewsBasic.css"/>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="left_sidebar well">
                    <div class="leftSubSidebar1">
                        <label>UVS-NID:</label>
                        <ul>
                            <li><a href="../IntroductionUVSNID/index.php">Introduction of UVS-NID.</a></li>
                            <li><a href="../UserManual/index.php">User manual.</a></li>
                            <li><a href="../WhyWhen/index.php">Why and when use.</a></li>
                            <li><a href="../RolesRegulation/index.php">Roles and regulation.</a></li>
                            <li>
                            ...
                            <li><a href="../BangladeshGoverment/index.php">Bangladesh Government.</a></li>
                            <li><a href="../UsefulLink/index.php">Useful Government link.</a></li>
            ...
            <div class="col-md-9 col-sm-12">
                <div class="middleContent well">
                    ...
                    <div class="newsPart1">
                        ...
                        Why and where used this UVS-NID system.
