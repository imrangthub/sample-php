                ...
                <div class="middleContent well">
                    <form class="form-horizontal" action="logOns.php" method="post">
                        <div class="form-group">
                            <label for="inputNIDno" class="col-sm-2 control-label">NID No:</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" id="inputNIDno" placeholder="Enter your NID number." name="nidNo">
                            </div>
                        </div>
                        <div class="form-group">
