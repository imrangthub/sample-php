        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12 ">
                <div class="middleContent well">
                    <h2 align="center">Paltan Thana</h2>
                    <form class="form-horizontal" action="logOns.php" method="post">
                        <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Officer Name:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="inputName" placeholder="Enter officer name" name="officerName">
                            </div>
                        </div>
                        <div class="form-group">
