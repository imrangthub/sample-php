                ...
                <div class="col-md-8">
                    <div class="content">
                        <div class="about_us" style=" height: 500px">
                            <h2>Set  Content and Attributes()</h2>

                            <button class=" btn btn-success" id="btn1">Show name</button>
                            <button class=" btn btn-success" id="btn2">Show Department</button>
                            <button class=" btn btn-success" id="btn3">Show Skill</button>
                            ...
                            <div class="para">
                                ...
                                <p id="p1"><strong>Department</strong></p>
                                <p id="p2">Skill</p>
                            </div>

                            <?php
                            function inputName(){
                                echo "MD IMARAN HOSSAIN";
                            }
                            ...
                            <script>
                                ...
                                $(document).ready(function(){
                                    ...
                                    $("#btn1").click(function(){
                                        $("#name").val("<?php inputName(); ?>");

                                    });

                                    $("#btn2").click(function(){
                                        $("#p1").html("<?php departmentName(); ?>");
                                    });

                                    $("#btn3").click(function(){
                                       $("#p2").text("<?php skillName(); ?>");
                                    });
