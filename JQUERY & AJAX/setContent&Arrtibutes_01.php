                ...
                <div class="col-md-8">
                    <div class="content">
                        <div class="about_us" style=" height: 500px">
                            <h2>Set  Content and Attributes(02)</h2>

                            <button class=" btn btn-success" id="btn1">Show Link</button>
                            <button class=" btn btn-success" id="btn2">Set a Link</button>
                            <button class=" btn btn-success" id="btn3">Set Title and Link</button>

                            <div class="para">


                                <p id="p1">This is a <strong>Paragraph</strong>. Now it's a Link
                                <a href="http://localhost/JQUERY%20&%20AJAX/setContent&Arrtibutes_00.php" title="setContent&Arrtibutes_00.php" id="link">Click</a> here
                                </p>
