        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="../../../views/Login/Manager/Manage/PoliceDepartment/RemoveBlockThana/removeBlockThana.php?action=search_Thana" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                            ...
                            <div class="item form-group">
                                <label class="col-md-3 col-sm-3 col-xs-12" for="thanaCode">Thana Code<span class="required"></span></label>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <!-- <input id="name" class="form-control col-md-7 col-xs-12"  name="title" placeholder="Name of the profilepic" required="required" type="text"> -->
                                    <label class="col-md-3 col-sm-3 col-xs-12" for="thanaCode">:
                                        ...
                                        if(!empty($_SESSION['thanaCode'])){
                                            echo $_SESSION['thanaCode'];
                                            $thanaCode= $_SESSION['thanaCode'];
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="../../../views/Login/Manager/Manage/PoliceDepartment/RemoveBlockThana/removeBlockThana.php?operation=remove_Thana"><button  class="btn btn-danger">Remove</button></a>
                                        <a href="../../../views/Login/Manager/Manage/PoliceDepartment/RemoveBlockThana/removeBlockThana.php?operation=block_Thana"><button class="btn btn-warning">Block</button></a>
                                        <a href="../../../views/Login/Manager/Manage/PoliceDepartment/RemoveBlockThana/removeBlockThana.php?operation=active_Thana"><button  class="btn btn-success">Active</button></a>
