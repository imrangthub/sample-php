        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="../../../views/Login/Manager/Manage/NIDManagement/AddNewNID/store.php?action=store_newNid" method="post" enctype="multipart/form-data">
