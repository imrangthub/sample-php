        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="../../../views/Login/Manager/Manage/HomeViews/UpcomingEvents/store.php?action=storeEvent" method="post" enctype="multipart/form-data">


                        <div style="position: relative; left: 378px;">
                        </div><br>
                        <div class="item form-group">
                            <label class="col-md-3 col-sm-3 col-xs-12" for="evTitle">Event Title <span class="required">*</span>
                            </label>
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                ...
                                <input id="evTitle" class="form-control col-md-7 col-xs-12"  name="title" placeholder="Event title"/>
                            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        Here you can manage your enent.
