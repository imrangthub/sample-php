...
<head>
    ...
    <title>NID holder | login</title>
    <link rel="stylesheet" href="../../../css/bootstrapCSS/bootstrap.min.css" />
    <link rel="stylesheet" href="../../../css/myCSS/styleBasicHome.css"/>
    <link rel="stylesheet" href="../../../css/myCSS/nidHolderPageStyle.css"/>
                    ...
                    <div class="loginContent well">
                        <div class="form-group">
                            <div class="loginTitle">
                                <h3 align="center">Please enter your National ID no and password.</h3>
                                <hr>
                            </div>
                        </div>
                        ...
                        <form class="form-horizontal" action="signIn.php" method="post">
                            <div class="form-group">
                                <label for="nidNo" class="col-sm-3 control-label">NID No:</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="nidNo" placeholder="Enter your NID Number " name="nidNo">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-10">
                                    ...
                                    <div class="LostPasswordMsg">
                                        <a href="ManagerSignIn/lostPassword.php">Lost password?</a>
                                    </div>
                                </div>
                            </div>
                        </form>
