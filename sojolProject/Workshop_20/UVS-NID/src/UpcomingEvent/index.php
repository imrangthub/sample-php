...
<head>
    ...
    <link rel="stylesheet" href="../../css/myCSS/upcomingEventPageStyle.css"/>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="menuBar">
                    ...
                    <li><a href="index.php">UPCOMING EVENT</a> </li>
                    <li><a href="#">LOGIN</a>
                        <!--Login dropdown -->
                        <nav>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="middleSubContent well">
                                ...
                                <div class="middleSubContent1 ">
                                    ...
                                    <h4><u>Upcoming Event</u></h4>
                                    <hr>
                                </div>

                                <div class="middleSubContent2 well">
                                    <ul>
                                        <li><a href="../../views/UpcomingEvent/index.php">Biomatric Sim re-registration .</a></li>
                                    </ul>
                                </div>
                            </div>
